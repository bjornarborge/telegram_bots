...
updater = Updater("5880261788:AAFQdzsxjGDJNkhksEKfzvh7ZnaKHVYp5fg",
                  use_context=True)
  
  
def start(update: Update, context: CallbackContext):
    update.message.reply_text(
        'Hello there my name is bjoernarborge, I am a bot created by @bjoernarborge.\n'
...
def linkedIn_url(update: Update, context: CallbackContext):
    update.message.reply_text("https://www.linkedin.com/in/bjoernarborge/")
